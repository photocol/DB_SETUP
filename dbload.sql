...
USE photocol;
SHOW DATABASES;
CREATE TABLE IF NOT EXISTS user(uid INT NOT NULL AUTO_INCREMENT, email VARCHAR(255) NOT NULL UNIQUE, username VARCHAR(255) NOT NULL,password VARCHAR(255) NOT NULL,PRIMARY KEY(uid));
